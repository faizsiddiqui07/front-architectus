      ...
      <div className="px-6 lg:px-12 py-10 sm:py-14 max-w-7xl mx-auto">
        ...
        >
          <motion.div variants={fadeIn} className="mb-10">
            <motion.p
              className="max-w-7xl mx-auto text-center text-xl text-gray-300 leading-relaxed"
          ...
          {/* Team Section */}
          <motion.div variants={fadeIn} className="mb-16">
            <p className="text-xl text-gray-300 leading-relaxed text-white mb-8 text-center">
          ...
          <motion.div variants={fadeIn} className="text-center">
            <p className="text-xl text-gray-300 leading-relaxed max-w-7xl mx-auto">
